...
func printRoleBindingRestriction(roleBindingRestriction *authorizationapi.RoleBindingRestriction, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printRoleBindingRestrictionList(roleBindingRestrictionList *authorizationapi.RoleBindingRestrictionList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printIsPersonalSubjectAccessReview(isPersonalSAR *authorizationapi.IsPersonalSubjectAccessReview, _ kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printSubjectRulesReview(subjectAccessReview *authorizationapi.SubjectRulesReview, _ kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printSelfSubjectRulesReview(selfSubjectAccessReview *authorizationapi.SelfSubjectRulesReview, _ kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printClusterRole(clusterRole *authorizationapi.ClusterRole, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printClusterRoleList(clusterRoleList *authorizationapi.ClusterRoleList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printRoleList(roleList *authorizationapi.RoleList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printRole(role *authorizationapi.Role, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printRoleBinding(roleBinding *authorizationapi.RoleBinding, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printRoleBindingList(roleBindingList *authorizationapi.RoleBindingList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printClusterRoleBinding(clusterRoleBinding *authorizationapi.ClusterRoleBinding, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	// TODO: Stop doing this
	return printRoleBinding(authorizationapi.ToRoleBinding(clusterRoleBinding), options)
}

func printClusterRoleBindingList(clusterRoleBindingList *authorizationapi.ClusterRoleBindingList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	// TODO: Stop doing this
