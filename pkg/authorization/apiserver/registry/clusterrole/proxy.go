...
func (s *REST) Create(ctx context.Context, obj runtime.Object, validateObjectFunc rest.ValidateObjectFunc, options *metav1.CreateOptions) (runtime.Object, error) {
	client, err := s.getImpersonatingClient(ctx)
	if err != nil {
		return nil, err
	}
	...
	if err := validateObjectFunc(ctx, convertedObj); err != nil {
		return nil, err
	}
...
func (s *REST) Update(ctx context.Context, name string, objInfo rest.UpdatedObjectInfo, createValidation rest.ValidateObjectFunc, updateValidation rest.ValidateObjectUpdateFunc, forceAllowCreate bool,
	...
	if err := updateValidation(ctx, updatedRole, oldRole); err != nil {
		return nil, false, err
	}
